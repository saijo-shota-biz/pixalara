 ...
 * Generated for Laravel 7.10.3 on 2020-05-08 18:51:11.
 *
...
namespace Illuminate\Support\Facades {
    ...
    class App {
        ...
        /**
         * Get the path to the application "store" directory.
         *
         * @param string $path
         * @return string
         * @static
    ...
    class Request {
         ...
         *
         * Be warned that enabling this features might lead to CSRF issues in your code.
